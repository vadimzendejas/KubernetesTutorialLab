...
Get the ACR login server name with the [az acr list](https://docs.microsoft.com/en-us/cli/azure/acr#list) command.
...
> [Scale Kubernetes application and infrastructure](./5-tutorial-kubernetes-scale.md)