...
If you haven't completed these steps, and want to follow along, return to [Tutorial 1 – Create container images](./1-tutorial-kubernetes-prepare-app.md). 
...
Get the login server name with the [az acr list](https://docs.microsoft.com/en-us/cli/azure/acr#list) command.
...
> [Monitor Kubernetes with Log Analytics](./7-tutorial-kubernetes-monitor.md)