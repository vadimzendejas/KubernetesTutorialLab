...
In previous tutorials, a container image was created and uploaded to an Azure Container Registry instance. If you have not done these steps, and would like to follow along, return to [Tutorial 1 – Create container images](./1-tutorial-kubernetes-prepare-app.md).
...
The following example creates a cluster named `myK8sCluster` in a Resource Group named `myResourceGroup`. This Resource Group was created in the [previous tutorial](./2-tutorial-kubernetes-prepare-acr.md).
...
> [Deploy application in Kubernetes](./4-tutorial-kubernetes-deploy-application.md)